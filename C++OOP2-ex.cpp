...
void test_template_template_parameters_1()
{
    ...
    //[Error] expected a template of type 'template<class T> class Container', got 'template<class _Tp, class _Alloc>
    //class std::list'
...
void test_template_template_parameters_2()
{
    ...
    //!	XCls<int, weak_ptr> p3;			//[Error] no matching function for call to
    //!'std::weak_ptr<int>::weak_ptr(int*)'
}
}  // namespace jj03
//-------------------------------------------------------------
#include <iostream>
